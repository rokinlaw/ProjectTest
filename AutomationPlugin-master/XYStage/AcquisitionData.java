...
public class AcquisitionData {
    ...
    protected ArrayList<ArrayList<JTextField>> pointInformation = new ArrayList<ArrayList<JTextField>>();
    ...
    protected ArrayList<JTextField> timeInfo = new ArrayList<JTextField>();
    protected ArrayList<JComboBox> timeUnitSelected = new ArrayList<JComboBox>();
    ...
    protected ArrayList<ArrayList<JList>> laserSelections = new ArrayList<ArrayList<JList>>();
